...
export const insertEventoParams = baseSchema
  .extend({
...
export const updateEventoParams = updateEventoSchema
  .extend({
    fechaInicio: z.coerce.date(),
  })
  .omit({
...
export type CompleteEvento = Awaited<
  ReturnType<typeof getEventos>
>["eventos"][number];
